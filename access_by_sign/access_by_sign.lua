...
--- Created by robin.wang.
--- DateTime: 2019/10/17 15:12
---
...
local function signcheck(params,secret)
    ...
    if sign ~= rightsign then
        --如果签名错误返回错误信息并记录日志
        --local mess="sign error: sign:"..sign.."right sign:"..rightsign.." sign_char:"..table.concat(signchar, "&")
